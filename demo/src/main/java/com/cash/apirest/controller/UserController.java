...
public class UserController {
	 ...
	 * se llame a la url http://127.0.0.1:8080/cash/users/
	 */
	 ...
	 * llame a la url http://127.0.0.1:8080/cash/users
	 */
	...
	/*
	 * Este método se hará cuando por una petición GET (como indica la anotación) se
	 * llame a la url + el id de un usuario http://127.0.0.1:8080/cash/users/1
	 */
...
//	 * se llame a la url + id del usuario http://127.0.0.1:8080/cash/users/1
//	 */
